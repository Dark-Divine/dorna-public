...
const Notification = () => {
    ...
    const getTopFiveWorkshops = () => {
        axios
            .get(
                `${process.env.REACT_APP_API_GATEWAY}api/doapi?func=GetTopFiveWorkshop&apikey=${process.env.REACT_APP_API_KEY}`
            )
    ...
    const getTopFivePurchasePackages = () => {
        axios
            .get(
                `${process.env.REACT_APP_API_GATEWAY}api/doapi?func=GetTopFivePurchasePackage&apikey=${process.env.REACT_APP_API_KEY}`
            )
            .then(function (response) {
    ...
    const tabs = [
        { key: 1, name: 'اعلان عمومی' },
        { key: 2, name: 'اعلان ویژه' },
        { key: 3, name: 'اعلان ویژه' },
    ]
                                    ...
                                    <ul class="tabs p-0 d-inline-flex align-items-center  justify-content-start w-md-100">
                                        <li class="d-flex align-items-center justify-content-center flex-column">
                                            <div
                                                ...
                                                class="tab-link active d-flex align-items-center justify-content-center flex-column"
                                            >
                                                اعلان عمومی
                                            </div>
                                        </li>
                                        <li class="d-flex align-items-center justify-content-center flex-column">
                                            <div
                                                ...
                                                class="tab-link d-flex align-items-center justify-content-center flex-column"
                                            >
                                                اعلان ویژه
                                            </div>
                                        </li>
                                            ...
                                            <div class="">
                                                {workshops?.map((w, i) => {
                                                    return (
                                                        <div
                                                            key={i}
                                                            className="notif-item d-flex align-items-start gap-3"
                                                        >
                                                            ...
                                                            <div className="flex-grow-1">
                                                                <div className="d-flex align-items-center justify-content-between gap-2 mb-3">
                                                                    ...
                                                                    <p className="notif-date d-flex align-items-center gap-2">
                                                                        {
                                                                            w.dateworkshopcontentcreated
                                                                        }
                                                                        <span></span>
                                                                    </p>
                                                                </div>
                                                                <div
                                                                    className="notif-text text-overflow"

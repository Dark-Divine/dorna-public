            ...
            <BrowserRouter>
                <Routes>
                    ...
                    <Route path="/exam">
                        ...
                        />
                        <Route
                            path="simulator/list/:id"
                            element={<ExamSimulatorList />}
                        />
                        <Route
                            path="simulator/exam/review/:id"
                            element={<ExamSimulatorReview />}
                        />
                        ...
                        />
                        <Route
                            path="result/:id/:examid"
                            element={<ExamResultById />}
                        />
                        <Route path="tag/:id" element={<ExamWithTag />} />
                        <Route
                            path="tag/review/:id"
                            element={<ExamWithTagId />}
                        />
                        <Route
                            path="review/:id"
                            element={<ExamReviewQuestionsWithAnswers />}
                        />
                        <Route
                            path="full-report"
                            element={<ExamResultFullReport />}
                        />
                        <Route
                            path="toggle/:id"
                            element={<ExamToggledQuestions />}
                        />
                    </Route>
                    <Route path="/disease">
